...
public class ProjectControllerTest {
    ...
    void testGetAllProjects_forEmptyResult() throws Exception {
     ...
     @Test
     void testCreateProject_ifAlreadyExist() throws Exception {
     ...
     @Test
     void testCreateProject_ifProjectObjectIsNull() throws Exception {
     ...
     @Test
     void testCreateProject_createProject() throws Exception {
         TEProjectDTO project = new TEProjectDTO();
         TEProjects newProject = new TEProjects(0,"Project1",null, false,0,null,0,null);
